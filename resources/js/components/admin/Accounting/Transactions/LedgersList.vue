    ...
    <div>
        <div class="container-fluid p-3">
            <div class="border-bottom text-muted p-3 d-flex justify-content-between align-items-center">
                ...
                <h5><button class="btn btn-outline-info border-0 btn-flat mr-3"><i class="fa-solid fa-plus"></i> Add Transaction</button><button class="btn btn-outline-info border-0 btn-flat"><i class="fa-solid fa-plus"></i> Add New Account</button></h5>                          
            </div>
                ...
                <table class="table table-striped border rounded">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>01</td>
                            <td><a href="#">ER-01</a></td>
                            <!-- <td>09-08-2024</td> -->
                            <td>Bill Payment</td>
                            <td><i class="fa-solid fa-circle-arrow-up pr-1 text-success"></i>Income</td>
                            <!-- <td><span class="badge badge-danger badge-pill">Bank</span></td> -->
                            <!-- <td>30nb-asad</td> -->
                            <td class="text-success">6000.00</td>
                            <td> Bill For March</td>
                            <!-- <td class="text-primary">6000.00 <sub>PKR</sub></td> -->
                            <td><i class="fa-regular fa-trash-can text-danger"></i></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox"/></td>
                            <td>02</td>
                            <td><a href="#">ER-02</a></td>
                            <!-- <td>09-08-2024</td> -->
                            <td>Hardware Purchase</td>
                            <td><i class="fa-solid fa-circle-arrow-down pr-1 text-danger"></i>Expense</td>
                            <!-- <td><span class="badge badge-success badge-pill">Cash</span></td> -->
                            <!-- <td>Ahmed Tech</td> -->
                            <td class="text-danger">2000.00</td>
                            <td>Pending Amount for Device</td>
                            <!-- <td class="text-primary">  4000.00 <sub>PKR</sub></td> -->
                            <td><i class="fa-regular fa-trash-can text-danger"></i></td>
                        </tr>
                    </tbody>
                </table>
